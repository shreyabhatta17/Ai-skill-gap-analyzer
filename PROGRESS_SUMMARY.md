...
Phase 0, Phase 1, and Phase 2 are complete. The project is ready for the standalone matching and recommendation phases. The knowledge base is a first draft and must be reviewed against real job postings and O*NET data before being treated as authoritative.
